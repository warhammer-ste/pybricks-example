...
This code assumes you are using the starter build as defined by LEGO (will link later. maybe), and will assume you add modifications to it based off sensors used.
